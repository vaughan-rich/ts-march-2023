// file needs renaming to .ts

var PI = 3.14; // should be a constant

// should set up some types for Shape, with some children Circle etc

// might be difficult to find enough commonailities here for a generic?
